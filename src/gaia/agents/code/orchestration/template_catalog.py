...
TEMPLATE_CATALOG: Dict[str, TemplateDefinition] = {
    ...
    "write_file": TemplateDefinition(
        name="write_file",
        description="Create or overwrite a file with the exact content you provide.",
        parameters={
            "file_path": ParameterSpec(
                type=ParameterType.STRING,
                description="Absolute or project-relative path to write (e.g., src/app/page.tsx).",
                example="src/app/page.tsx",
            ),
            "content": ParameterSpec(
                type=ParameterType.STRING,
                description="Full file contents to write, including imports and JSX.",
            ),
            "create_dirs": ParameterSpec(
                type=ParameterType.BOOLEAN,
                description="Create parent directories if they do not exist.",
                required=False,
                default=True,
            ),
            "project_dir": ParameterSpec(
                type=ParameterType.STRING,
                description="Root directory of the project (auto-populated).",
                required=False,
            ),
        },
        dependencies=[],
        produces=["Custom file updates"],
        category="remediation",
        semantic_hints=[
            "Use when validation reveals missing or corrupted files.",
            "Always provide the complete desired file content.",
        ],
    ),
    "edit_file": TemplateDefinition(
        name="edit_file",
        description="Perform a targeted replacement within an existing file.",
        parameters={
            "file_path": ParameterSpec(
                type=ParameterType.STRING,
            ...
            "old_content": ParameterSpec(
                type=ParameterType.STRING,
                description="Exact snippet to replace.",
            ),
            "new_content": ParameterSpec(
                type=ParameterType.STRING,
        ...
        dependencies=[],
        produces=["Edited file content"],
        category="remediation",
        semantic_hints=[
            "Use for small targeted fixes such as imports, metadata, or hooks.",
            "Keep snippets concise to avoid accidental large replacements.",
        ],
    ),
